...
const ProfilePage: React.FC<ProfilePageProps> = ({ isDarkMode, toggleDarkMode }) => {
  ...
  const models: Model[] = [
    ...
    },
    {
      ...
      name: 'Mixtral 8x7B',
      category: 'base',
      description: 'Mixture-of-experts architecture providing excellent performance with reasonable resource requirements.',
      specs: {
        parameters: '8x7B',
        contextWindow: '32K',
        latency: 'Medium',
    ...
    },
    {
      ...
      recommended: ['Advanced reasoning', 'Step-by-step solutions', 'Scientific and technical domains']
    }
  ];
